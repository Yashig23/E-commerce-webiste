...
function DashboardTab() {
    ...
    const { mode,  product, deleteProducts, editItem, order, user } = context
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                       ...
                                       {product.map((items,index)=>{
                                        ...
                                        const {title, price,category, image, date, id} = items
                                        return  <tbody className='' key={id}>
                                        <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'transparent' : '', color: mode === 'dark' ? 'white' : '', }} >
                                            <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                               {index + 1}
                                            </td>
                                            <th scope="row" className="px-6 py-4 font-medium text-black whitespace-nowrap">
                                                <img className = " w-[80px] h-[90px]" src={image} alt="image"/>
                                            </th>
                                            <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                {title}
                                            </td>
                            ...
                            <div className="relative overflow-x-auto mb-16">
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>Order Details</h1>
                                    {order.map((allorders,index)=>{
                                        return(
                                           <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                            <thead  className="text-xs text-black uppercase bg-gray-200 " style={{ backgroundColor: mode === 'dark' ? 'transparent' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                    <tr>
                                                    <th scope="col" className="px-6 py-3">
                                                        Payment Id
                                                    </th>
                                            ...
                                            {/* {allorders.cartItems.map((items, index)=>( */}
                                            {allorders.cartItems.map((items,index)=>(
                                                console.log(items),
                                                ...
                                                <tbody>
                                                 ...
                                                 <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'transparent' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                            ...
                                                            <th scope="row" className="px-6 py-4 font-medium text-black whitespace-nowrap">
                                                                <img className='w-16' src={items.image} alt="img" />
                                                            </th>
                                                            <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                {items.title}
                                                            </td>
