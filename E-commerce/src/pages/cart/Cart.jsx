...
import MyContextPro from '../../context/data/MyContextPro';
...
const grandTotal  = shippingCharge + amount;
...
const buyNow = async () => {
  ...
  var options = {
    key: "rzp_test_fkUw4UyZLdyElT",
    key_secret: "8NNw6fs1Rcd8mSWxTJYMeHWu",
    ...
    handler: function (response) {
      ...
      try {
        ...
        console.log("successfully saved 123")
      } catch (error) {
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
            ...
            {cartItems.map((item,index)=>{
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <h2 className="text-sm  text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>{item.category}</h2>
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            <div className="flex justify-between">
              ...
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>{shippingCharge}</p>
            </div>
            <hr className="my-4" />
